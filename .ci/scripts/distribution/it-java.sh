...
mvn -B -T$LIMITS_CPU -s ${MAVEN_SETTINGS_XML} org.apache.maven.plugins:maven-dependency-plugin:3.1.2:go-offline org.apache.maven.plugins:maven-dependency-plugin:3.1.2:resolve-plugins -Pskip-unstable-ci,prepare-offline
